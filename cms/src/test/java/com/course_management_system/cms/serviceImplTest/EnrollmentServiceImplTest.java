...
class EnrollmentServiceImplTest {
    ...
    void enrollThrowsWhenRegistrationHasNotStarted() {
        EnrollmentRequest request = enrollmentRequest();
        course.setRegistrationStart(LocalDateTime.now().plusDays(1));
        course.setRegistrationEnd(LocalDateTime.now().plusDays(2));
    ...
    void enrollThrowsWhenRegistrationIsClosed() {
        EnrollmentRequest request = enrollmentRequest();
        course.setRegistrationStart(LocalDateTime.now().minusDays(3));
        course.setRegistrationEnd(LocalDateTime.now().minusDays(1));
